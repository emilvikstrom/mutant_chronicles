defmodule MutantChroniclesWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MutantChroniclesWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/mutant_chronicles_web/templates",
        namespace: MutantChroniclesWeb
